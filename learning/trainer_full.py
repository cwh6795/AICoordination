...
opt_ = Adam(lr=0.0001, beta_1=0.9, beta_2=0.999, epsilon=None, decay=0.0, amsgrad=False)
...
train_iterator = DirectoryIteratorWithBoundingBoxes("./data/full_cat7/train", train_datagen, target_size=(200, 200))

test_iterator = DirectoryIteratorWithBoundingBoxes("./data/full_cat7/val", test_datagen, target_size=(200, 200))
...
early_stopper = EarlyStopping(monitor='val_loss',
                              patience=30,
                              verbose=1)
checkpoint = ModelCheckpoint('./models/full.h5')
...
final_model.fit_generator(custom_generator(train_iterator),
                          steps_per_epoch=500,
                          epochs=20, validation_data=custom_generator(test_iterator),
...
final_model2.load_weights('./models/full.h5')
...
test_iterator = DirectoryIteratorWithBoundingBoxes("./data/full_cat7/test", test_datagen, target_size=(200, 200))
...
with open('./models/full.json', 'w') as jfile:
