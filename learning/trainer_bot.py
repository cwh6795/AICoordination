...
class DirectoryIteratorWithBoundingBoxes(DirectoryIterator):
    ...
    def next(self):
        ...
        if self.class_mode == 'sparse':
            ...
            batch_y = np.zeros((len(batch_x), 6), dtype=K.floatx())
...
y = Dense(6, activation='softmax', name='img')(x)
...
y2 = Dense(6, activation='softmax', name='img')(x2)
...
train_iterator = DirectoryIteratorWithBoundingBoxes("./data/bot_cat6/train", train_datagen, target_size=(200, 200))

test_iterator = DirectoryIteratorWithBoundingBoxes("./data/bot_cat6/val", test_datagen, target_size=(200, 200))
...
early_stopper = EarlyStopping(monitor='val_loss',
                              patience=30,
                              verbose=1)
checkpoint = ModelCheckpoint('./models/bot.h5')
...
final_model.fit_generator(custom_generator(train_iterator),
                          ...
                          epochs=60, validation_data=custom_generator(test_iterator),
...
final_model2.load_weights('./models/bot.h5')
...
test_iterator = DirectoryIteratorWithBoundingBoxes("./data/bot_cat6/test", test_datagen, target_size=(200, 200))
...
with open('./models/bot.json', 'w') as jfile:
