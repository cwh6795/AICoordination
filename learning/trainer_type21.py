...
class DirectoryIteratorWithBoundingBoxes(DirectoryIterator):
    ...
    def next(self):
        ...
        if self.class_mode == 'sparse':
            ...
            batch_y = np.zeros((len(batch_x), 21), dtype=K.floatx())
...
y = Dense(21, activation='softmax', name='img')(x)

x2 = model_resnet2.output
x2 = Dense(512, activation='elu', kernel_regularizer=l2(0.001))(x2)
y2 = Dense(21, activation='softmax', name='img')(x2)
...
train_iterator = DirectoryIteratorWithBoundingBoxes("./data/type_cat21/train", train_datagen, target_size=(200, 200))

test_iterator = DirectoryIteratorWithBoundingBoxes("./data/type_cat21/val", test_datagen, target_size=(200, 200))
...
lr_reducer = ReduceLROnPlateau(monitor='val_loss',
                               ...
                               factor=0.5,
                               verbose=1)
tensorboard = TensorBoard(log_dir='./logs/type')
early_stopper = EarlyStopping(monitor='val_loss',
                              patience=30,
                              verbose=1)
checkpoint = ModelCheckpoint('./models/type/model_type21.h5')
...
final_model2.load_weights('./models/type/model_type21.h5')
...
test_iterator = DirectoryIteratorWithBoundingBoxes("./data/type_cat21/test", test_datagen, target_size=(200, 200))
...
with open('./models/type/model_type21.json', 'w') as jfile:
