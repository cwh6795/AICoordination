...
class DirectoryIteratorWithBoundingBoxes(DirectoryIterator):
    ...
    def next(self):
        ...
        if self.class_mode == 'sparse':
            ...
            batch_y = np.zeros((len(batch_x), 8), dtype=K.floatx())
...
train_iterator = DirectoryIteratorWithBoundingBoxes("./data/top_cat8/train", train_datagen, target_size=(200, 200))

test_iterator = DirectoryIteratorWithBoundingBoxes("./data/top_cat8/val", test_datagen, target_size=(200, 200))
...
early_stopper = EarlyStopping(monitor='val_loss',
                              patience=30,
                              verbose=1)
checkpoint = ModelCheckpoint('./models/top.h5')
...
final_model2.load_weights('./models/top.h5')
...
test_iterator = DirectoryIteratorWithBoundingBoxes("./data/top_cat8/test", test_datagen, target_size=(200, 200))
...
with open('./models/top.json', 'w') as jfile:
