...
class DirectoryIteratorWithBoundingBoxes(DirectoryIterator):
    ...
    def next(self):
        ...
        if self.class_mode == 'sparse':
            ...
            batch_y = np.zeros((len(batch_x), 7), dtype=K.floatx())
...
train_iterator = DirectoryIteratorWithBoundingBoxes("./data/style_cat7/train", train_datagen, target_size=(200, 200))

test_iterator = DirectoryIteratorWithBoundingBoxes("./data/style_cat7/val", test_datagen, target_size=(200, 200))
...
lr_reducer = ReduceLROnPlateau(monitor='val_loss',
                               ...
                               factor=0.5,
                               verbose=1)
tensorboard = TensorBoard(log_dir='./logs/style')
early_stopper = EarlyStopping(monitor='val_loss',
                              patience=30,
                              verbose=1)
checkpoint = ModelCheckpoint('./models/style/model_style7.h5')
...
final_model2.load_weights('./models/style/model_style7.h5')
...
test_iterator = DirectoryIteratorWithBoundingBoxes("./data/style_cat7/test", test_datagen, target_size=(200, 200))
...
with open('./models/style/model_style7.json', 'w') as jfile:
